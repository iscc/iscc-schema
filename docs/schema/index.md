...
| ---- | ---- | --------|--------------------------------|
| @context | `string-uri` | http://purl.org/iscc/context/0.3.8.jsonld | The [JSON-LD](https://json-ld.org/) Context URI for ISCC metadata.         |
...
| Name | Type | Default | Definition                     |
| ---- | ---- | --------|--------------------------------|
| $schema | `string-uri` | http://purl.org/iscc/schema/0.3.8.json | The [JSON Schema](https://json-schema.org/) URI for ISCC metadata.         |
