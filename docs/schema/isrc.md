...
icon: lucide/music
title: ISRC Seed
description: ISRC seed metadata.
---
...
!!! example
    ...
    ```json
    {
      "$schema": "http://purl.org/iscc/schema/isrc-0.8.0.json",
      "isrc": "AA6Q72000047",
...
| Name | Type | Default | Definition                     |
| ---- | ---- | --------|--------------------------------|
| $schema | `string-uri` | http://purl.org/iscc/schema/isrc-0.8.0.json | The JSON Schema URI for ISRC seed metadata.         |
