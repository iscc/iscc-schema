...
#   filename:  iscc-generator-service.yaml
#   timestamp: 2022-01-29T23:24:53+00:00
...
class BaseRequest(BaseModel):
    file: Optional[bytes] = Field(None, description="A media file to create an ISCC for.")
    url: Optional[AnyUrl] = Field(None, description="URL to a media file to create an ISCC for.")
...
class NftRequest(BaseRequest, IsccBasic, IsccEmbeddable):
    ...
    redirect: Optional[AnyUrl] = Field(
        None,
        description=(
            "URI to which an ISCC resolver should redirect for this item. May be an URI Template"
            " where `{iscc-id}` will be replaced with the calculated ISCC-ID"
        ),
...
class IsccRequest(BaseRequest, IsccBasic, IsccEmbeddable):
    pass
