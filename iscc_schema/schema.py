...
#   timestamp: 2022-01-03T16:12:57+00:00
...
class IsccCrypto(BaseModel):
    ...
    datahash: Optional[str] = Field(
        None,
        context="http://purl.org/iscc/terms/#datahash",
        description=(
    ...
    metahash: Optional[str] = Field(
        None,
        context="http://purl.org/iscc/terms/#metahash",
        description=(
    ...
    tophash: Optional[str] = Field(
        None,
        context="http://purl.org/iscc/terms/#tophash",
        description=(
