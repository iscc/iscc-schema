...
#   filename:  iscc.yaml
#   timestamp: 2022-01-02T09:56:24+00:00
...
class IsccMetadataSchema(BaseModel):
    """
    ...
    schema_: Optional[AnyUrl] = Field(
        'https://purl.org/iscc/schema/0.2.0.json',
        alias='$schema',
        description='JSON Schema URI for ISCC metadata.',
    )
    iscc: str = Field(
        ...,
